  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      <View style={{flex : 1, flexDirection: 'column', justifyContent: 'center'}}>
        ...
        <Text style={{color:"black"}}>faq button here</Text>
        <Text style={{color:"black"}}>application process listing button here</Text>
      </View>
    </SafeAreaView>
  );
}
...
export default withScreenBase(ScreenQuestions, ScreenBaseType.MAIN, navigationOptions);
