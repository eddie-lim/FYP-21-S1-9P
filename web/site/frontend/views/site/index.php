...
?>
<div class="site-landing shadow-lg bg-white rounded">
    <section class="content-section hero-image-container">
        <div class="col-md-12 mb-4 text-center hero-image-text">
    ...
    <section class="content-section">
        <div class="col-lg-6 col-md-12 mb-3 p-0 h-100">
            <img src="img/image1.jpg" class="info-image">
        </div>
        <div class="col-lg-6 col-md-12 mb-3 p-0 h-100 d-md-block d-lg-flex flex-column justify-content-center">
            <h2 class="h1-reponsive text-uppercase text-center"><strong>About Us</strong></h2><br>
            <p class="info-body">We are a group of final year students working on our final year project which is to develop a SIM open house mobile application. The objective of our mobile app is to enable students who are interested in full time and part time studies in diploma or bachelor programmes offered by SIM and its other partner universities to readily browse courses, get school information, and register for the relevant briefing programmes and events.</p>
        </div>
    </section>

    <section class="content-section">
        <div class="col-lg-6 col-md-12 mb-3 p-0 h-100 mobile-section">
            <img src="img/image2.jpg" class="info-image">
        </div>
        <div class="col-lg-6 col-md-12 mb-3 p-0 h-100 d-md-block d-lg-flex flex-column justify-content-center">
            <h2 class="h1-reponsive text-uppercase text-center"><strong>Our Product</strong></h2><br>
            <p class="info-body">As there are already existing similar applications available for use in the market, we explored and implemented the features which would benefit our target audience the most. In addition, the mobile app is seamlessly integrated with our customized content management system whereby SIM admin and university partners admins can upload their school related information and details. Such flexibility in content upload not only allows easy maintenance of the application in the future but also helps captivate both internal and external stakeholders of SIM.</p>
        </div>
        <div class="col-lg-6 col-md-12 mb-3 p-0 h-100 non-mobile-section">
            <img src="img/image2.jpg" class="info-image">
        </div>
    ...
    <div class="row d-flex justify-content-center col-lg-12 col-md-11 m-auto">
        <div class="col-md-4">
            <div class="team-box">
                <div class="team-pic">
